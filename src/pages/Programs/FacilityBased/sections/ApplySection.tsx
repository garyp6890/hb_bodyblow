...
export default function ApplySection() {
  return (
    <div className="max-w-4xl mx-auto mb-20">
      <div className="bg-yellow-500 rounded-2xl p-8 md:p-12 text-center relative overflow-hidden">
        ...
        <div className="relative">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            Ready to Join Our Facility-Based Programs?
          </h2>
          <p className="text-xl text-gray-800 mb-8 max-w-2xl mx-auto">
            Take the first step towards enriching activities, skill development, and a supportive community.
          </p>
          <Link 
            to="/programs/apply"
